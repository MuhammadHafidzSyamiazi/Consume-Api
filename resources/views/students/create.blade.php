...
<html lang="en">
  ...
  <body>
      <div class="d-flex justify-content-center align-items-center container my-5">
          <div class="card my-4">
            <div class="container">
            <form action="/students/store" method="post" style="width:450px;" enctype="multipart/from-data">
            @csrf
          ...
          <div class="mb-3">
            ...
            <input type="date" id="" name="tgl_lahir" class="form-control" placeholder="Masukan Tanggal Lahir">
          </div>
          <div class="mb-3">
